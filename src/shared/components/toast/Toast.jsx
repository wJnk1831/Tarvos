...
export function Toast() {
  ...
  async function setupListener() {
    ...
    return await webview.listen('new-notification', (event) => {
  ...
  return (
    <div id="toast-container" className="inline-flex flex-col gap-3 w-[280px] select-none">
      {messages.map((msg) => (
        <div key={msg.id} className="w-full h-[80px] glass-card p-4 flex gap-4 items-center animate-in fade-in slide-in-from-right-4 duration-300">
